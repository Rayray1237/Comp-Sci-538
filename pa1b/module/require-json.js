...
if (require_._cache.hasOwnProperty(resolvedName)) {
  return require_._cache[resolvedName].exports;
}
...
const module = { exports: parsedContent };
require_._cache[resolvedName] = module;
...
require_.loader = (
  function(origLoader) {
    return function(resolvedName, nextLoader) {
      ...
      return origLoader(resolvedName, nextLoader);
    };
  })(require_.loader);
